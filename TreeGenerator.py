...
def main():
    ...
    camera = THREE.PerspectiveCamera.new(90, window.innerWidth/window.innerHeight, 0.1, 1000)
    ...
    geom_rota = Object.fromEntries(to_js(geom_rota))
    ...
    param_folder.add(geom_rota, 'rotation', 1,20,1)
    param_folder.open()
    """
    #-----------------------------------------------------------------------
...
def draw_system(axiom, start_pt):
    move_vec = THREE.Vector3.new(0,3,0)
    old_states = []
    old_move_vecs = []
    lines = []
